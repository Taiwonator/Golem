...
const slideTexts: React.ReactNode[] = [
  <>
    <Text tag="p" bold size="standard--large">
  ...
  <>
    <Text tag="p">14 years after the commencement of its operations, GOLEM scope of operations 
  ...
  <>
    <Text tag="p">This requires the setting 
