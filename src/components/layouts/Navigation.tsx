...
const Item: React.FC<IItem> = ({ children, button }) => {
    return (
        <li className={classNames(styles['navigation__link'], button && styles['navigation__link--button'])}><Link>{ children }</Link></li>
    )
}
